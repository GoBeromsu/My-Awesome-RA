...
export type LayoutContextValue = LayoutContextOwnStates & {
  ...
  setEvidencePanelOpen: Dispatch<
    SetStateAction<LayoutContextValue['evidencePanelOpen']>
  >
...
export const LayoutProvider: FC<React.PropsWithChildren> = ({ children }) => {
  ...
  // whether the evidence panel is open
  const [evidencePanelOpen, setEvidencePanelOpen] = usePersistedState<boolean>(
